@testset "fq_nmod_embed.embed" begin
    ...
    for i in 1:10
        ...
        k1, x1 = Native.finite_field(p, 1, "x1")
        k2, x2 = Native.finite_field(p, 2, "x2")
        k3, x3 = Native.finite_field(p, 3, "x3")
        k4, x4 = Native.finite_field(p, 4, "x4")
        k6, x6 = Native.finite_field(p, 6, "x6")
        k8, x8 = Native.finite_field(p, 8, "x8")
        k9, x9 = Native.finite_field(p, 9, "x9")
        k12, x12 = Native.finite_field(p, 12, "x12")
        k16, x16 = Native.finite_field(p, 16, "x16")
        k18, x18 = Native.finite_field(p, 18, "x18")
        k24, x24 = Native.finite_field(p, 24, "x24")
...
@testset "fq_nmod_embed.transitive_closure" begin
    ...
    for i in 1:40
        ...
        K1 = Native.finite_field(P1, "r1")[1]
        K2 = Native.finite_field(P2, "r2")[1]
        K3 = Native.finite_field(P3, "r3")[1]
        K4 = Native.finite_field(P4, "r4")[1]
