################################################################################
#
#  FqPolyRepPolyRingElem.jl: Flint FqPolyRepPolyRingElem (Polynomials over FqPolyRepField)
#
################################################################################
...
function similar(f::PolyElem, R::FqPolyRepField, s::Symbol=var(parent(f)); cached::Bool=true)
